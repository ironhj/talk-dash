...
const Login = () => {
	...
	return (
		<div className='flex flex-col items-center justify-center min-w-96 mx-auto'>
			<div className='w-full p-6 rounded-lg shadow-md bg-yellow-600 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0'>
				<h1 className='text-4xl font-semibold text-center text-white'>
					Login <br />
					<span className='text-blue-600'> Talk Dash</span>
					<br /> 
				</h1>
